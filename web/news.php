        ...
        <nav class="navbar navbar-inverse">
            ...
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#" class="hvr-underline-from-center">TIN TỨC</a></li>
                </ul>
            </div>
        </nav>        
    </div>
        ...
        <div class="new_info">
            <div class="box_detail">
                ...
                <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)) {?>
                        <div class="box_new">
                        <a href="new_detail.php?id=<?php echo $row['new_id'] ?>" class="img">
                            <img src="new/<?php echo $row['new_img'] ?>" title="<?php echo $row['new_name'] ?>">
                        </a>
                        <h2><a href="new_detail.php?id=<?php echo $row['new_id'] ?>"><b><?php echo $row["new_name"] ?></b></a></h2>
                        <span class="summary">
                            <p><?php echo $row["new_describe"] ?></p>
                        </span>
                    </div>
                    <?php
                    }
