...
<div class="header">
    <div class="header_top">
        <div id="tonghop">
            <div class="tonghop">
                <div class="logo"><a title="banner" href="#"><img alt="banner" title="banner" src="img/LOGO_T21.png" /></a></div>
            <!--end logo-->
        <div class="tong">
    ...
    <div class="menu">
        ...
        <div class="convetion">
            <div id="slider">
                <img class="slide" src="img/anh_slide.jpg" stt="0" style="width: 100%;height: 350px">
                <img class="slide" src="img/anh_slide_2.jpg" stt="1" style="width: 100%;height: 350px;display: none;">
                <img class="slide" src="img/anh_slide_3.jpg" stt="2" style="width: 100%;height: 350px;display: none;">
                <a id="prev">&#10094;</a>
                <a id="next">&#10095;</a>
            </div>
        </div>          
...
<div class="body">
    ...
    <div class="products">
        ...
        <?php 
            $sql_cate = "SELECT * FROM category WHERE cate_id = '1'";
        ...
        <div class="box_product" id="block">
            <?php
                $sql_product = "SELECT * FROM product WHERE p_cate = '1' LIMIT 8 ";
            ...
            ?>
                <p class='xem_tat_ca'><a href="all_product.php?cate_id=1" class="btn btn-primary"> Xem tất cả >></a></p>
        </div>
    </div>
    <div class="products">
        <div class="title_center_bottom">
        <?php 
            $sql_cate = "SELECT * FROM category WHERE cate_id = '2'";
            $result_cate = mysqli_query($conn, $sql_cate);
            $row_cate = mysqli_fetch_array($result_cate);
         ?>
            <span><p class="title_ct"><?php echo $row_cate["cate_name"] ?></p></span>
        ...
        <div class="box_product" id="block">
            <?php
                $sql_product = "SELECT * FROM product WHERE p_cate = '2' LIMIT 8 ";
                $result_product = mysqli_query($conn, $sql_product);
                while ($row_product = mysqli_fetch_array($result_product)) {?>
                <div class="item_product1">
                    <a class="img" href="product_detail.php?id=<?php echo $row_product["p_id"] ?> & cate_id=<?php echo $row_product['p_cate'] ?>">
            ...
            ?>
                <p class='xem_tat_ca'><a href="all_product.php?cate_id=2" class="btn btn-primary"> Xem tất cả >></a></p>
        </div>
    </div>
    <div class="products">
        <div class="title_center_bottom">
        <?php 
            $sql_cate = "SELECT * FROM category WHERE cate_id = '3'";
            $result_cate = mysqli_query($conn, $sql_cate);
            $row_cate = mysqli_fetch_array($result_cate);
         ?>
            <span><p class="title_ct"><?php echo $row_cate["cate_name"] ?></p></span>
        ...
        <div class="box_product" id="block">
            <?php
                $sql_product = "SELECT * FROM product WHERE p_cate = '3' LIMIT 8 ";
                $result_product = mysqli_query($conn, $sql_product);
                while ($row_product = mysqli_fetch_array($result_product)) {?>
                <div class="item_product1">
                    <a class="img" href="product_detail.php?id=<?php echo $row_product["p_id"] ?> & cate_id=<?php echo $row_product['p_cate'] ?>">
            ...
            ?>
                <p class='xem_tat_ca'><a href="all_product.php?cate_id=3" class="btn btn-primary"> Xem tất cả >></a></p>
        </div>
    </div>
    <div class="products">
        <div class="title_center_bottom">
        <?php 
            $sql_cate = "SELECT * FROM category WHERE cate_id = '4'";
            $result_cate = mysqli_query($conn, $sql_cate);
            $row_cate = mysqli_fetch_array($result_cate);
         ?>
            <span><p class="title_ct"><?php echo $row_cate["cate_name"] ?></p></span>
        ...
        <div class="box_product" id="block">
            <?php
                $sql_product = "SELECT * FROM product WHERE p_cate = '4' LIMIT 8 ";
                $result_product = mysqli_query($conn, $sql_product);
                while ($row_product = mysqli_fetch_array($result_product)) {?>
                <div class="item_product1">
                    <a class="img" href="product_detail.php?id=<?php echo $row_product["p_id"] ?> & cate_id=<?php echo $row_product['p_cate'] ?>">
            ...
            ?>
                <p class='xem_tat_ca'><a href="all_product.php?cate_id=4" class="btn btn-primary"> Xem tất cả >></a></p>
        </div>
    </div>
    <div class="products">
        <div class="title_center_bottom">
        <?php 
            $sql_cate = "SELECT * FROM category WHERE cate_id = '5'";
            $result_cate = mysqli_query($conn, $sql_cate);
            $row_cate = mysqli_fetch_array($result_cate);
         ?>
            <span><p class="title_ct"><?php echo $row_cate["cate_name"] ?></p></span>
        ...
        <div class="box_product" id="block">
            <?php
                $sql_product = "SELECT * FROM product WHERE p_cate = '5' LIMIT 8 ";
                $result_product = mysqli_query($conn, $sql_product);
                while ($row_product = mysqli_fetch_array($result_product)) {?>
                <div class="item_product1">
                    <a class="img" href="product_detail.php?id=<?php echo $row_product["p_id"] ?> & cate_id=<?php echo $row_product['p_cate'] ?>">
            ...
            ?>
                <p class='xem_tat_ca'><a href="all_product.php?cate_id=5" class="btn btn-primary"> Xem tất cả >></a></p>
        </div>
    </div>     
</div>
<!-- Footer -->
