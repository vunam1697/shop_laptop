    ...
    <form id="form1" runat="server">
        <div class="container body">
            <div class="main_container">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Bảng loại sản phẩm <small><a href="../thucthi/add-classify.php" class="btn btn-info"><i class="fa fa-plus"> Thêm loại sản phẩm</i></a></small></h2>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tbody>
                                  <tr class="even pointer">
                                    ...
                                    <td class=" "><?php echo $row["cate_id"] ?></td>
                                    <td class=" "><?php echo $row["cate_name"] ?> </td>
                                    <td class=" last" style="text-align: center;"><a href="../thucthi/update_classify.php?id=<?php echo $row["cate_id"] ?>"><i class="fa fa-edit" style="font-size:20px"></i></a>
                                    </td>
                                    <td class=" last" style="text-align: center;"><a onclick="return delete_classify();" href="../thucthi/delete_classify.php?id=<?php echo $row["cate_id"] ?>"><i class="fa fa-trash-o" style="font-size:20px"></i></a>    
                                    </td>
                                  </tr>
                                </tbody>
                            <?php    
