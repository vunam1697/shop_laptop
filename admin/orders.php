            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          <div class="x_title">
                            <h2>Bảng Hóa Đơn <small></small></h2>
                              ...
                              <table class="table table-striped jambo_table bulk_action">
                                <thead>
                                  <tr class="headings">
                                    ...
                                    <th class="column-title no-link last" colspan="3" style="text-align: center;"><span class="nobr">Thao tác</span>
                                    </th>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tbody>
                                          <tr class="even pointer">
                                            ...
                                            <td class=" last" style="text-align: center;"><a href="order_detail.php?id=<?php echo $row["id"] ?>">Chi tiết</a>
                                            </td>
                                            <td class=" last" style="text-align: center;"><a href="thucthi/update_orders.php?id=<?php echo $row["id"] ?>"><i class="fa fa-edit" style="font-size:20px"></i></a>
                                            </td>
                                            <td class=" last" style="text-align: center;"><a onclick="return delete_orders();" href="thucthi/delete_orders.php?id=<?php echo $row["id"] ?>"><i class="fa fa-trash-o" style="font-size:20px"></i></a>    
                                            </td>
                                          </tr>
                                        </tbody>
                                    <?php    
