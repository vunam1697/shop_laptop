                ...
                <div class="right_col" role="main">
                    ...
                    <div class="page-header">
                        ...
                        <?php 
                            ...
                            $image = "";
                            if (isset($_POST["cmd"])) {
                                $user = isset($_POST['Coursetk'])?$_POST['Coursetk']:'';
                                $name = isset($_POST['CourseName'])?$_POST['CourseName']:'';
                                $pass = isset($_POST['CoursePass'])?$_POST['CoursePass']:'';
                                $email = isset($_POST['CourseEmail'])?$_POST['CourseEmail']:'';
                                $image = isset($_FILES['CourseImg'])?$_FILES['CourseImg']["name"]:'';
                                
                                $insert = "INSERT INTO user(user_id,username,fullname,password,email,img,role)
                                        VALUES ('','".$user."','".$name."','".$pass."','".$email."','".$image."')";
                                
                                $sql = mysqli_query($conn, $insert);
                                
                                echo "<script type='text/javascript'>";
                                echo "alert('Thêm thành công!')</script>";
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="Coursetk" type="text" style="width: 500px" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Tên nhân viên </label>
                                                            <input class="form-control" name="CourseName" type="text" style="width: 500px" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Mật khẩu </label>
                                                            <input class="form-control" name="CoursePass" type="password" style="width: 500px"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Email </label>
                                                            <input class="form-control" name="CourseEmail" type="text" style="width: 500px" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Ảnh đại diện </label>
                                                            <input type="file" name="CourseImg">
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form_sep">
                                                                    <a href="../user.php" class="btn btn-primary">Quay lại</a>
                                                                    <input class="btn btn-primary" name="cmd" type="submit" value="Thêm" style="float: right;" /> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
