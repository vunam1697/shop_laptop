                    ...
                    <div class="page-header">
                        ...
                        <?php 
                            ...
                            if (isset($_POST['btnSubmit'])) {
                                if (empty($_POST['CourseName']) || empty($_FILES['CourseImg1']) || empty($_POST['CourseTitle1']) || empty($_FILES['CourseImg2'])|| empty($_POST['CourseTitle2']) || empty($_POST['Courseckeditor1'])|| empty($_POST['Courseckeditor2']) || empty($_POST['Courseckeditor3'])) {
                                    echo '<script>alert("Vui lòng không để trống!"); </script>';
                                } else{
                                    $name = $_POST['CourseName'];
                                    $anhc = $_FILES['CourseImg1']['name'];
                                    $anhct = $_FILES['CourseImg2']['name'];
                                    $tieudec = $_POST['CourseTitle1'];
                                    $tieudect = $_POST['CourseTitle2'];
                                    $motaD = $_POST['Courseckeditor1'];
                                    $motaG = $_POST['Courseckeditor2'];
                                    $motaC = $_POST['Courseckeditor3'];
                                    if ($row['new_name'] == $name && $row['new_img'] == $anhc && $row['new_img_1'] == $anhct && $row['new_title'] == $tieudec && $row['new_title_1'] == $tieudect && $row['new_describe'] == $motaD && $row['new_describe_1'] == $motaG && $row['new_describe_2'] == $motaC) {
                                        /*header("location: http://localhost:8888/project4/admin/list-product.php");*/
                                    }else{
                                        $update = "UPDATE news SET new_name='$name',new_img='$anhc',new_img_1='$anhct',new_title='$tieudec',new_title_1='$tieudect',new_describe='$motaD',new_describe_1='$motaG',new_describe_2='$motaC' WHERE new_id=".$id;
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="CourseName" type="text" value="<?php echo $row['new_name'] ?>" />
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="CourseTitle1" type="text" value="<?php echo $row['new_title'] ?>" />
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="CourseTitle2" type="text" value="<?php echo $row['new_title_1'] ?>" />
                                                </div>
                                                <div class="form-group">
                                                    <label for="reg_input_name" class="req">Mô tả đầu</label><br>
                                                    <textarea cols="50" class="ckeditor" rows="10" id="detail" name="Courseckeditor1"><?php echo $row['new_describe'] ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="reg_input_name" class="req">Mô tả giữa</label><br>
                                                    <textarea cols="50" class="ckeditor" rows="10" id="detail" name="Courseckeditor2"><?php echo $row['new_describe_1'] ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="reg_input_name" class="req">Mô tả cuối</label><br>
                                                    <textarea cols="50" class="ckeditor" rows="10" id="detail" name="Courseckeditor3"><?php echo $row['new_describe_2'] ?></textarea>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-5">
                                                        <div class="form_sep">
