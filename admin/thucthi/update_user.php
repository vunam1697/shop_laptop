                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="../images/img.jpg" alt="" /> Vu Nam
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="page-header">
                        ...
                        <?php 
                            ...
                            if (isset($_POST['cmd'])) {
                                if (empty($_POST['CourseName']) || empty($_POST['CoursePass']) || empty($_POST['CourseEmail'])) {
                                    echo '<script>alert("Vui lòng không để trống!"); </script>';
                                } else{
                                    $user = $_POST['Coursetk'];
                                    $name = $_POST['CourseName'];
                                    $pass = $_POST['CoursePass'];
                                    $email = $_POST['CourseEmail'];
                                    $image = $_FILES['CourseImg']["name"];
                                    if ($row['username'] == $user && $row['fullname'] == $name && $row['password'] == $pass && $row['email'] == $email && $row['img'] == $image) {
                                        /*header("location: http://localhost:8888/project4/admin/list-product.php");*/
                                    }else{
                                        
                                        $update = "UPDATE user SET username='$user',fullname='$name',password='$pass',email='$email',img='$image' WHERE user_id=".$id;
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Mã NV</label>
                                                            <input class="form-control" value="<?php echo $row['user_id'] ?>" name="CourseId" readonly="readonly" type="text" style="width: 500px" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Tài khoản </label>
                                                            <input class="form-control" value="<?php echo $row['username'] ?>" name="Coursetk" type="text" style="width: 500px"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Họ và tên </label>
                                                            <input class="form-control" value="<?php echo $row['fullname'] ?>" name="CourseName" type="text" style="width: 500px"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Mật khẩu </label>
                                                            <input class="form-control" value="<?php echo $row['password'] ?>" name="CoursePass" type="password" style="width: 500px"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Email </label>
                                                            <input class="form-control" value="<?php echo $row['email'] ?>" name="CourseEmail" type="text" style="width: 500px"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Ảnh </label>
