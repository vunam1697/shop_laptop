                    ...
                    <div class="page-header">
                        ...
                        <?php 
                            ...
                            if (isset($_POST["btnSubmit"])) {
                                $tensp = isset($_POST['CourseName'])?$_POST['CourseName']:'';
                                $phanloai = isset($_POST['classify'])?$_POST['classify']:'';
                                $soluong = isset($_POST['CourseNumber'])?$_POST['CourseNumber']:'';
                                $gia = isset($_POST['CoursePrice'])?$_POST['CoursePrice']:'';
                                $img = isset($_FILES['CourseImg'])?$_FILES['CourseImg']['name']:'';
                                $mota = isset($_POST['Courseckeditor'])?$_POST['Courseckeditor']:'';
                                
                                $insert_product = "INSERT INTO product(p_id,p_name,p_cate,p_number,p_img,p_price,p_describe)
                                    VALUES (0,'".$tensp."','".$phanloai."','".$soluong."','".$img."','".$gia."','".$mota."')";
                                ...
                                if ($sql_product) {
                                    ...
                                    echo "<script type='text/javascript'>";
                                    echo "alert('Thêm thất bại')</script>";
                                }
                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="reg_input_name">Loại giày </label>
                                                    <select class="form-control" data-required="true" name="classify" style="width: 200px" >
                                                        <?php 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="CoursePrice" type="text" style="width: 500px" />
                                                </div>
                                                <div class="form-group">
                                                    <label for="reg_input_name" class="req">Số lượng </label>
                                                    <input class="form-control" name="CourseNumber" type="text" style="width: 500px" />
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea cols="50" class="ckeditor" rows="10" id="detail" name="Courseckeditor"></textarea>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-5">
                                                        <div class="form_sep">
                                                            <input class="btn btn-info" name="btnSubmit" type="submit" value="Thêm" /> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
