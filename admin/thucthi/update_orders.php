                ...
                <div class="right_col" role="main">
                    ...
                    <div class="page-header">
                        ...
                        <?php 
                            ...
                            if (isset($_POST['cmd'])) {
                                if (empty($_POST['CourseName']) || empty($_POST['CourseAddress']) || empty($_POST['CourseEmail']) || empty($_POST['CoursePhone'])) {
                                    echo '<script>alert("Vui lòng không để trống!"); </script>';
                                } else{
                                    $name = $_POST['CourseName'];
                                    $email = $_POST['CourseEmail'];
                                    $address = $_POST['CourseAddress'];
                                    $phone = $_POST['CoursePhone'];
                                    if ($row['user_fullname'] == $name && $row['email'] == $email && $row['address'] == $address && $row['phone'] == $phone) {
                                        /*header("location: http://localhost:8888/project4/admin/list-product.php");*/
                                    }else{
                                        $update = "UPDATE orders SET user_fullname='$name',email='$email',address='$address',phone='$phone' WHERE id=".$id;
                                    ...
                                    <div class="col-sm-6">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">Cập nhật hóa đơn</h4>
                                            </div>
                                            <div class="panel-body">
                                                <div class="col-sm-12">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Tên khách hàng </label>
                                                            <input size="84" maxlength="45" class="form-control" value="<?php echo $row['user_fullname'] ?>" name="CourseName" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Email </label>
                                                            <input size="84" maxlength="45" class="form-control" value="<?php echo $row['email'] ?>" name="CourseEmail" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Địa chỉ </label>
                                                            <input size="84" maxlength="45" class="form-control" value="<?php echo $row['address'] ?>" name="CourseAddress" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Số điện thoại </label>
                                                            <input size="84" maxlength="45" class="form-control" value="<?php echo $row['phone'] ?>" name="CoursePhone" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Ngày đặt </label>
                                                            <input size="84" maxlength="45" class="form-control" value="<?php echo $row['createdate'] ?>" name="CourseDate" readonly="readonly" type="text" />
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form_sep">
