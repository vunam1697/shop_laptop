                        ...
                        <?php 
                            ...
                            if (isset($_POST['cmd'])) {
                                if (empty($_POST['CourseName'])) {
                                    ...
                                    if ($row['cate_name'] == $name ) {
                                        
                                    }else{
                                        $update = "UPDATE category SET cate_name='$name' WHERE cate_id=".$id;
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Mã danh mục</label>
                                                            <input size="84" maxlength="45" class="form-control" value="<?php echo $row['cate_id'] ?>" name="CourseId" readonly="readonly" type="text" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reg_input_name" class="req">Tên danh mục sản phẩm </label>
                                                            <input size="84" maxlength="45" class="form-control" value="<?php echo $row['cate_name'] ?>" name="CourseName" type="text" />
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form_sep">
