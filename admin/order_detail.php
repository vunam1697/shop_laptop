            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          <div class="x_title">
                            <h2>Bảng Chi Tiết Hóa Đơn <small></small></h2>
                            ...
                            <div class="table-responsive">
                              <table class="table table-striped jambo_table bulk_action">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM order_detail,product WHERE product.p_id=order_detail.product_id AND order_id=".$_GET["id"];
                                    $result = mysqli_query($conn, $sql);
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tbody>
                                          <tr class="even pointer">
                                            ...
                                            <td class=" "><?php echo $row["p_name"] ?> </td>
                                            <td class=" "><?php echo $row["quantity"] ?> </td>
                                            <td class=" "><?php echo $row["price"] ?> </td>
                                            <td class=" "><?php echo $row["datecreate"] ?> </td>
                                            <td class=" last" style="text-align: center;"><a href="thucthi/update_orderdetail.php?id=<?php echo $row["id"] ?>"><i class="fa fa-edit" style="font-size:20px"></i></a>
                                            </td>
                                            <td class=" last" style="text-align: center;"><a onclick="return delete_orderdetail();" href="thucthi/delete_orderdetail.php?id=<?php echo $row["id"] ?>"><i class="fa fa-trash-o" style="font-size:20px"></i></a>    
                                            </td>
                                          </tr>
                                        </tbody>
                                    <?php    
