            ...
            <div class="main_container">
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a href="#"><i class="fa fa-desktop"></i>Quản lý người dùng </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                        <li>
                                            <a>
                                                ...
                                                <span>
                                                    <span><?php echo $row_img["fullname"] ?></span>
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          <div class="x_title">
                            <h2>Bảng người dùng <small><a href="thucthi/adduser.php" class="btn btn-info"><i class="fa fa-user"> Thêm người dùng</i></a></small></h2>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tbody>
                                          <tr class="even pointer">
                                            ...
                                            <td class=" "><img style="width: 50px;height: 50px" src="image/<?php echo $row["img"] ?>"> </td>
                                            <td class=" last" style="text-align: center;"><a href="thucthi/update_user.php?id=<?php echo $row["user_id"] ?>"><i class="fa fa-edit" style="font-size:20px"></i></a>
                                            </td>
                                            <td class=" last" style="text-align: center;"><a onclick="return delete_user();" href="thucthi/delete_user.php?id=<?php echo $row["user_id"] ?>"><i class="fa fa-trash-o" style="font-size:20px"></i></a>    
                                            </td>
                                          </tr>
                                        </tbody>
                                    <?php    
