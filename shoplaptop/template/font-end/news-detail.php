		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-9 padd-large">
					<h2 class="pjdetail-title">Right to access, correct and delete data and to object to data processing</h2>
					<p class="amblog-date">Tin tức  —  01 / 26 / 2018</p>
					...
					<div class="pj-info">
						<img src="images/news-detail1.png" alt="">
						...
						<img src="images/news-detail2.png" alt="">
						...
						<img src="images/news-detail3.png" alt="">
						<div class="social-share"><img src="images/social-share.png" alt=""></div>
					</div>
				</div>
				<div class="col-md-3">
					<div class="news-hot sticky-top">
						<h2 class="news-title">Xem nhiều nhất</h2>
						<div class="blog-trend">
							<div class="blog-trend__item">
								<div class="row">
									...
									<div class="col-md-6">
										<h6 class="blogtrend-name"><a href="">Providing and mindful spaces that are 100%</a></h6>
									</div>
								</div>
							</div>
							<div class="blog-trend__item">
					...
					<div class="col-md-3 col-md-custom">
						<div class="post-item">
							<div class="post-photo">
								<a href=""><img src="images/related.png" alt=""></a>
							</div>
							<h3 class="amblog-headline"><a href="">Providing authentic and minful spaces that are 100%</a></h3>
						</div>
					</div>
					<div class="col-md-3 col-md-custom">
						<div class="post-item">
